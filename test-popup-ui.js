...
assert(!/date-label date-label--watch">特关/.test(popupJs), '特关置顶分组不再使用写死的特关日期浮标');
assert(/Object\.entries\(pinnedGroups\)\.forEach\(\(\[dateLabel,\s*items\]\)/.test(popupJs), '特关置顶内容按实际日期分组显示浮标');
