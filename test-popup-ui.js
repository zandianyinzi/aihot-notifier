...
assert(hasDeclaration(watchRulesListScrollRule, 'max-height', '228px'), '特关规则列表预留更合理的可视高度');
...
assert(hasDeclaration(watchRuleContentRule, 'grid-row', /1\s*\/\s*span\s*2/), '规则内容区纵向覆盖两行');
