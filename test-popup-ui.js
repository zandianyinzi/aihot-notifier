...
assert(hasDeclaration(watchRuleCardRule, 'border', /1px\s+solid\s+var\(--border-light\)/), '已保存规则卡片使用稳定实线边界');
assert(!/border\s*:\s*1px\s+dashed/i.test(watchRuleCardRule), '已保存规则卡片不使用草稿感虚线');
